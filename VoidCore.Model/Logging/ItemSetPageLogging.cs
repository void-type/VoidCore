...
namespace VoidCore.Model.Logging
{
    ...
    public class ItemSetPageLogging<TRequest, TResponse> : FallibleLogging<TRequest, IItemSetPage<TResponse>>
    {
        /// <summary>
        ...
        public override void OnSuccess(TRequest request, IResult<IItemSetPage<TResponse>> successfulResult)
        {
