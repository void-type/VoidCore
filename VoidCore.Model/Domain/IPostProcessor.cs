namespace VoidCore.Model.Domain
{
    ...
    /// Post processing has access to the request and response and therefore should respect immutability of the request and response. Post processing
    /// should also not block the main thread and should be considered "fire and forget."
    /// </summary>
