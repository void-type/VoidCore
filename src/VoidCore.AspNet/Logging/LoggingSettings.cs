namespace VoidCore.AspNet.Logging
{
    ...
    public class LoggingSettings
    {
        ...
        /// The full path to the file. Serilog will append the date before the extension. If left null, a default path
        /// will be chosen
        /// </param>
        ...
        /// <summary>
        /// The path to the logging file. This can be OS-sensitive. If null or whitespace, a default path is chosen by
        /// the logger.
        /// </summary>
